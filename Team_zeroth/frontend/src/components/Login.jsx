          ...
          <div className="hidden lg:block">
            <div className="bg-gradient-to-br from-emerald-700 to-emerald-800 rounded-3xl p-12 text-white shadow-2xl">
              ...
              <p className="text-emerald-100 text-lg mb-8">
                Continue supporting families and communities across Nepal. Every
                contribution begins with people like you.
              </p>
              ...
              <div className="space-y-4">
                {[
                  [
                    'Trusted Campaigns',
                    'Every story is verified before reaching donors',
                  ],
                  [
                    'Community Support',
                    'Help reaches people when they need it most',
                  ],
                ].map(([title, desc]) => (
